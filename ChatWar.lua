local Chat_War = {}
Chat_War.optionEnable = Menu.AddOption({"Kostya12rus","Chat War"}, "Activate", "")

function Chat_War.OnUpdate()
  if not Menu.IsEnabled(Chat_War.optionEnable) then return end
...
function Chat_War.OnChatEvent(chatEvent)
...
function Chat_War.OnGameStart()
  Chat_War.init()
end
function Chat_War.OnGameEnd()
  Chat_War.init()
end
Chat_War.init()
return Chat_War