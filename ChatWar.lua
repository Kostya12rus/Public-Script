...
Не забываем про запятые, без них скрипт не работает

Можно использовать сокращения
<NICK_KILLER>      - Ник игрока который убил
<HERO_NAME_KILLER> - Герой который убил
<NICK_DEAD>		   - Ник умершего
<HERO_NAME_DEAD>   - Погибщий герой

В стриках можно использовать 
<STREAKS>          - Количество совершенных убийств за стрик

В убийствах курьера можно испольховать 
